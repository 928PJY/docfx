...
namespace Microsoft.DocAsCode.Build.Engine
{
    ...
    internal sealed class HostService : IHostService, IDisposable
    {
        ...
        public MarkupResult Markup(string markdown, FileAndType ft, bool omitParse, bool isEnabledValidation)
        {
            if (markdown == null)
            {
            ...
            return MarkupCore(markdown, ft, omitParse, isEnabledValidation);
        }
        ...
        private MarkupResult MarkupCore(string markdown, FileAndType ft, bool omitParse, bool isEnabledValidation)
        {
            try
            {
                var mr = MarkdownService.Markup(markdown, ft.File, isEnabledValidation);
                if (omitParse)
                {
                    return mr;
                }
