    ...
    internal class DocsetBuilder
    {
        ...
        public void Build(params string[] files)
        {
            try
            {
                ...
                var templateEngine = new TemplateEngine(_errors, _config, output, _docsetPackage, _packageResolver, new Lazy<JsonSchemaTransformer>(() => jsonSchemaTransformer!), _buildOptions, _jsonSchemaLoader);
                ...
                var redirectionProvider = new RedirectionProvider(_buildOptions.DocsetPath, _config.HostName, _errors, _buildScope, _docsetPackage, _buildOptions.Repository, documentProvider, _monikerProvider, new Lazy<PublishUrlMap>(() => publishUrlMap!));
