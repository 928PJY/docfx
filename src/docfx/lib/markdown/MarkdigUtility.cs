...
namespace Microsoft.Docs.Build
{
    internal static class MarkdigUtility
    {
        ...
        public static MarkdownPipelineBuilder Use(this MarkdownPipelineBuilder builder, Action<MarkdownPipeline, IMarkdownRenderer> rendererSeter)
        {
            builder.Extensions.Add(new DelegatingExtension(null, rendererSeter));
            return builder;
        }
