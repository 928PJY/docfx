...
namespace Microsoft.Docs.Build
{
    internal class BuildCore
    {
        ...
        public List<Error> BuildFile(DocumentUri uri, string textContent)
        {
            ...
            BuildFileCore(Context, file);
            return Context.ErrorBuilder.GetErrorsOnFile(file);
        }

        public static List<Diagnostic> ConvertToDiagnostics(List<Error> errors)
        {
        ...
        private static void BuildFileCore(Context context, FilePath path)
        {
