...
namespace Microsoft.Docs.Build
{
    internal class TextDocumentHandler : ITextDocumentSyncHandler
    {
        ...
        public Task<Unit> Handle(DidChangeTextDocumentParams notification, CancellationToken token)
        {
            ...
            var errors = _buildCore.BuildFile(notification.TextDocument.Uri, notification.ContentChanges.First().Text);

            var diagnostics = BuildCore.ConvertToDiagnostics(errors);
        ...
        public async Task<Unit> Handle(DidOpenTextDocumentParams notification, CancellationToken token)
        {
            ...
            _logger.LogInformation($"Validating document {notification.TextDocument.Uri}");
            var errors = _buildCore.BuildFile(notification.TextDocument.Uri, notification.TextDocument.Text);
