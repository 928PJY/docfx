    ...
    public static class DocfxTest
    {
        ...
        private static void RunCore(string docsetPath, string outputPath, TestData test, DocfxTestSpec spec, Dictionary<string, string> variables, DirectoryPackage docsetPackage)
        {
            ...
            else if (spec.Locale != null)
            {
                ...
                {
                    RunBuild(locDocsetPath, outputPath, test, spec, docsetPackage.CreateSubPackage(locDocsetPath));
                }
            }
            else
            {
                RunBuild(docsetPath, outputPath, test, spec, docsetPackage);
            }
        }
        ...
        private static void RunBuild(string docsetPath, string outputPath, TestData test, DocfxTestSpec spec, DirectoryPackage docsetPackage)
        {
